    ...
    >
      {items.map((item, idx) => {
        ...
        >
          ...
          <div className="rounded-md w-full p-2 overflow-hidden bg-neutral-950 group-hover:ring-4 ring-green-500 relative z-20 transition-all duration-500 cursor-pointer">
