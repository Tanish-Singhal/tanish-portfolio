    ...
    <div className="py-10 px-5 sm:p-0 mt-7">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {projectData.map((project, index) => (
          <div
            key={index}
            className="max-w-sm rounded-[12px] overflow-hidden shadow-lg bg-zinc-800"
          >
            ...
            <div className="px-6 py-2 mb-3 flex gap-3">
              <Link href={project.website} className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-2 px-4 rounded-lg mr-2" target="_blank">
                  Live Demo
              </Link>
              <Link href={project.github} className="flex items-center justify-center gap-2 bg-gray-700 hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-lg" target="_blank">
                  <SiGithub />
                  <span>GitHub</span>
              </Link>
            </div>
